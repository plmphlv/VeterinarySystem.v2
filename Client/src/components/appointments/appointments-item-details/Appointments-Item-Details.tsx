                        ...
                        <div className="appointment-card" key={appointmentDetails?.id}>
                            ...
                            <p><i className="fa-solid fa-pen"></i> Staff Member Name: {appointmentDetails.staffMemberName}</p> */}
                                ...
                                <div className="appointment-actions">
                                    <Link to={`/appointments/${id}/update-request`} className="edit-request">Update</Link>
                                    <Link to={`/appointments/${id}/delete-request`} className="delete-request">Delete</Link>
                                </div>
                                <Link to="/appointments" className="my-pets-item-info-back-link">← Back to Appointments</Link>
                            </div>
                        </div>
                    </section>
                </>
